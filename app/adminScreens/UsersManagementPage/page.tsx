...
export default function UserManagementPage() {
  ...
  if (authLoading || loading) return <div className="p-10 text-center">טוען נתונים...</div>;
    ...
    <main className="min-h-screen bg-gray-50 p-6" dir="rtl">
      <div className="max-w-6xl mx-auto">
        ...
        <section className="mb-10">
           <h2 className={`text-xl font-bold mb-4 border-b-2 pb-2 ${isShowingAdmins ? 'text-purple-600 border-purple-200' : 'text-blue-600 border-blue-200'}`}>
              ⏳ {isShowingAdmins ? 'מנהלים' : 'משתמשים'} בהמתנה לאישור ({pendingUsers.length})
            </h2>
