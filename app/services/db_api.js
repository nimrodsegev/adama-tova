...
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhraW9jZmJwdGt1amJ6eGh5dnV5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjUzNTU2ODMsImV4cCI6MjA4MDkzMTY4M30.YDj6te6LCGswNWTovPlANZyyVVbMNa8JwcP-mpRavzQ"
...
export const apiUser = {
  ...
  async createTestUser() {
    ...
    if (profileError) {
      ...
      return [null, "Auth created, but profile failed: " + profileError.message];
    }
